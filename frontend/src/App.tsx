...
const DESA_NAME = "Sumbermulyo";
const KECAMATAN = "Bambanglipuro";
const KABUPATEN = "Bantul";
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            <iframe
              ...
              src="https://maps.google.com/maps?q=Bambanglipuro+Bantul+Yogyakarta&t=&z=13&ie=UTF8&iwloc=&output=embed"
