...
export const metadata: Metadata = {
  title: "Kontak",
  description: "Hubungi Pemerintah Desa Selorejo - alamat, email, telepon, dan form pesan.",
};
          ...
          <div className="bg-white p-8 lg:p-10 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 text-lg">Jam Pelayanan</h4>
                  <p className="text-gray-600 mt-1">Senin – Jumat, 08.00 – 15.00 WIB</p>
                </div>
              </div>
            </div>
          </div>
