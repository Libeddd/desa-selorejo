...
export const metadata: Metadata = {
  ...
  description: "Profil lengkap perangkat desa dan struktur pemerintahan Desa Selorejo, Kabupaten Magetan.",
};

export default function PerangkatDesa() {
  // Data perangkat desa Selorejo
  const PERANGKAT = [
    { nama: "H. Supriyadi, S.IP.", jabatan: "Kepala Desa", foto: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop" },
    { nama: "Dra. Rini Kartika", jabatan: "Sekretaris Desa", foto: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop" },
    ...
    { nama: "Budi Santoso", jabatan: "Kaur Umum", foto: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop" },
    { nama: "Dewi Lestari", jabatan: "Kasi Pemerintahan", foto: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=400&fit=crop" },
  ];
